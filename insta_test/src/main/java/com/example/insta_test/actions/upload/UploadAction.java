package com.example.insta_test.actions.upload;

import com.example.insta_test.IGClient;
import com.example.insta_test.models.media.UploadParameters;
import com.example.insta_test.requests.upload.MediaUploadFinishRequest;
import com.example.insta_test.requests.upload.RuploadPhotoRequest;
import com.example.insta_test.requests.upload.RuploadSegmentVideoGetRequest;
import com.example.insta_test.requests.upload.RuploadSegmentVideoPhaseRequest;
import com.example.insta_test.requests.upload.RuploadSegmentVideoPhaseRequest.Phase;
import com.example.insta_test.requests.upload.RuploadVideoRequest;
